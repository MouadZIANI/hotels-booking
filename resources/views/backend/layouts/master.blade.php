...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('backend/css/Lobibox.min.css') }}">
...
@include('backend._partiales._header')

<div class="content-wrapper" style="min-height: 800px !important;">
    @yield('content')
</div>

@include('backend._partiales._aside')
...
<script src="{{ asset('backend/js/lobibox.js') }}"></script>
